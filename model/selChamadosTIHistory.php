...
$sql = "SELECT
            ...
            CH.ID_CATEGORIA, CAT.descr AS categoria, STS.descr AS status, PRIORI.DESCR AS prioridade,
            CH.hora_abertura, CH.data_abertura, CH.hora_fechamento, CH.data_fechamento, CH.AVALIACAO,
